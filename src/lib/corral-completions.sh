...
set -l commands install update versions prune uninstall status search browse pull list ls remove rm run serve launch ps profile template help
...
_${sn//-/_}_completions() {
  ...
  # shellcheck disable=SC2154
  local commands="install update versions prune uninstall status search browse pull list ls remove rm run serve launch ps profile template help"
